...
def page_dashboard():
    ...
    kpis = [
        {"label": "23 Opérations Actives", "icon": "🏢", "color": "kpi-blue", "page": "portefeuille"},
        {"label": "485k€ REM Mon Portefeuille", "icon": "💰", "color": "kpi-green", "page": "rem"},
        {"label": "3 Freins Actifs", "icon": "⚠️", "color": "kpi-orange", "page": "freins"},
        {"label": "5 Échéances Semaine", "icon": "📅", "color": "kpi-red", "page": "planning"}
    ]
